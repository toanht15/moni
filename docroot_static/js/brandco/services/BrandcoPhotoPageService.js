var BrandcoPhotoPageService = (function() {
    var curPage = 1;
            ...
            var moreUrl = $('input[name="more_page_url"]').val(),
                param = {
                    ...
                    success: function(response) {
                        ...
                        $('.photoPageList li:last-child').after(response);
...
$(document).ready(function(){
    $(document).on('mousedown', '.panelClick', function() {
        BrandcoPhotoPageService.recordPanelClick($(this).data('link'), $(this).data('entry'), $(this).data('type'), $(this).data('entry_id'));
    });

    $('#more_panel').on('click', function() {
        BrandcoPhotoPageService.loadNextPage();
    });
});