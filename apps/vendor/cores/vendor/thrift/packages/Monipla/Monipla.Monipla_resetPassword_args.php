 ...
 *  @generated
 */
class Monipla_resetPassword_args {
  static $_TSPEC;
  ...
  public function getName() {
    return 'Monipla_resetPassword_args';
  }
      ...
      switch ($fid)
      {
        case 1:
          if ($ftype == TType::STRUCT) {
            $this->parameter = new Thrift_ResetPasswordParameter();
  ...
  public function write($output) {
    $xfer = 0;
    $xfer += $output->writeStructBegin('Monipla_resetPassword_args');
