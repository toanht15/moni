 ...
 *  @generated
 */
class Monipla_searchEnterprises_args {
  static $_TSPEC;
  ...
  public function getName() {
    return 'Monipla_searchEnterprises_args';
  }
      ...
      switch ($fid)
      {
        case 1:
          if ($ftype == TType::STRUCT) {
            $this->params = new Thrift_SearchParameter();
  ...
  public function write($output) {
    $xfer = 0;
    $xfer += $output->writeStructBegin('Monipla_searchEnterprises_args');
    if ($this->params !== null) {
