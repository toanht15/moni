 ...
 *  @generated
 */
class Monipla_checkEnterpriseBackdoorLogin_args {
  static $_TSPEC;
  ...
  public function getName() {
    return 'Monipla_checkEnterpriseBackdoorLogin_args';
  }
      ...
      switch ($fid)
      {
        case 1:
          if ($ftype == TType::STRUCT) {
            $this->parameter = new Thrift_LoginTokenParameter();
  ...
  public function write($output) {
    $xfer = 0;
    $xfer += $output->writeStructBegin('Monipla_checkEnterpriseBackdoorLogin_args');
