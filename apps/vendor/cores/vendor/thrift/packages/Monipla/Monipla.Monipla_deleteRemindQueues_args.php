 ...
 *  @generated
 */
class Monipla_deleteRemindQueues_args {
  static $_TSPEC;
  ...
  public function getName() {
    return 'Monipla_deleteRemindQueues_args';
  }
      ...
      switch ($fid)
      {
        case 1:
          if ($ftype == TType::STRUCT) {
            $this->params = new Thrift_DeleteRemindQueuesParameter();
  ...
  public function write($output) {
    $xfer = 0;
    $xfer += $output->writeStructBegin('Monipla_deleteRemindQueues_args');
    if ($this->params !== null) {
