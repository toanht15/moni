 ...
 *  @generated
 */
class Monipla_subtractPoint_args {
  static $_TSPEC;
  ...
  public function getName() {
    return 'Monipla_subtractPoint_args';
  }
      ...
      switch ($fid)
      {
        case 1:
          if ($ftype == TType::STRUCT) {
            $this->point = new Thrift_SubtractPoint();
  ...
  public function write($output) {
    $xfer = 0;
    $xfer += $output->writeStructBegin('Monipla_subtractPoint_args');
    if ($this->point !== null) {
