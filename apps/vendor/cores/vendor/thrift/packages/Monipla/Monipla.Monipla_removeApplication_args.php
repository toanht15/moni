 ...
 *  @generated
 */
class Monipla_removeApplication_args {
  static $_TSPEC;
  ...
  public function getName() {
    return 'Monipla_removeApplication_args';
  }
      ...
      switch ($fid)
      {
        case 1:
          if ($ftype == TType::STRUCT) {
            $this->params = new Thrift_ApplicationRemover();
  ...
  public function write($output) {
    $xfer = 0;
    $xfer += $output->writeStructBegin('Monipla_removeApplication_args');
    if ($this->params !== null) {
