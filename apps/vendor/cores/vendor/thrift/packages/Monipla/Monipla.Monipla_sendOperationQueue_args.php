 ...
 *  @generated
 */
class Monipla_sendOperationQueue_args {
  static $_TSPEC;
  ...
  public function getName() {
    return 'Monipla_sendOperationQueue_args';
  }
      ...
      switch ($fid)
      {
        case 1:
          if ($ftype == TType::STRUCT) {
            $this->params = new Thrift_SendOperationQueueParameter();
  ...
  public function write($output) {
    $xfer = 0;
    $xfer += $output->writeStructBegin('Monipla_sendOperationQueue_args');
    if ($this->params !== null) {
