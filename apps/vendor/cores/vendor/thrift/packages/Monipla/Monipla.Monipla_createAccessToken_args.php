 ...
 *  @generated
 */
class Monipla_createAccessToken_args {
  static $_TSPEC;
  ...
  public function getName() {
    return 'Monipla_createAccessToken_args';
  }
      ...
      switch ($fid)
      {
        case 1:
          if ($ftype == TType::STRUCT) {
            $this->parameter = new Thrift_AuthorizationCodeParameter();
  ...
  public function write($output) {
    $xfer = 0;
    $xfer += $output->writeStructBegin('Monipla_createAccessToken_args');
