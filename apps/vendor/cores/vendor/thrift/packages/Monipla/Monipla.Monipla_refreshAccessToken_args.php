 ...
 *  @generated
 */
class Monipla_refreshAccessToken_args {
  static $_TSPEC;
  ...
  public function getName() {
    return 'Monipla_refreshAccessToken_args';
  }
      ...
      switch ($fid)
      {
        case 1:
          if ($ftype == TType::STRUCT) {
            $this->parameter = new Thrift_RefreshTokenParameter();
  ...
  public function write($output) {
    $xfer = 0;
    $xfer += $output->writeStructBegin('Monipla_refreshAccessToken_args');
