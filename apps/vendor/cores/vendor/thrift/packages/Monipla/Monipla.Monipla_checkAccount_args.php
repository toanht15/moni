 ...
 *  @generated
 */
class Monipla_checkAccount_args {
  static $_TSPEC;
  ...
  public function getName() {
    return 'Monipla_checkAccount_args';
  }
      ...
      switch ($fid)
      {
        case 1:
          if ($ftype == TType::STRUCT) {
            $this->parameter = new Thrift_AccountCheckParameter();
  ...
  public function write($output) {
    $xfer = 0;
    $xfer += $output->writeStructBegin('Monipla_checkAccount_args');
