 ...
 *  @generated
 */
class Monipla_getOperationQueues_args {
  static $_TSPEC;
  ...
  public function getName() {
    return 'Monipla_getOperationQueues_args';
  }
      ...
      switch ($fid)
      {
        case 1:
          if ($ftype == TType::STRUCT) {
            $this->params = new Thrift_OperationQueuesQuery();
  ...
  public function write($output) {
    $xfer = 0;
    $xfer += $output->writeStructBegin('Monipla_getOperationQueues_args');
    if ($this->params !== null) {
