 ...
 *  @generated
 */
class Monipla_setSNSAccessToken_args {
  static $_TSPEC;
  ...
  public function getName() {
    return 'Monipla_setSNSAccessToken_args';
  }
      ...
      switch ($fid)
      {
        case 1:
          if ($ftype == TType::STRUCT) {
            $this->params = new Thrift_SocialAccessToken();
  ...
  public function write($output) {
    $xfer = 0;
    $xfer += $output->writeStructBegin('Monipla_setSNSAccessToken_args');
    if ($this->params !== null) {
