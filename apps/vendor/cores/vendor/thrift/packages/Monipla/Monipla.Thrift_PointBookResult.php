 ...
 *  @generated
 */
class Thrift_PointBookResult {
  static $_TSPEC;

  public $result = null;
  public $pointBooks = null;
  ...
  public function __construct($vals=null) {
    ...
    if (is_array($vals)) {
      ...
      if (isset($vals['pointBooks'])) {
        $this->pointBooks = $vals['pointBooks'];
      }
      ...
      switch ($fid)
      {
        ...
        case 2:
          if ($ftype == TType::LST) {
            ...
            {
              $elem81 = null;
              $elem81 = new Thrift_PointBook();
              $xfer += $elem81->read($input);
              $this->pointBooks []= $elem81;
            }
  ...
  public function write($output) {
    $xfer = 0;
    $xfer += $output->writeStructBegin('Thrift_PointBookResult');
    if ($this->result !== null) {
    ...
    if ($this->pointBooks !== null) {
      if (!is_array($this->pointBooks)) {
        throw new TProtocolException('Bad type in structure.', TProtocolException::INVALID_DATA);
      }
      $xfer += $output->writeFieldBegin('pointBooks', TType::LST, 2);
      {
        $output->writeListBegin(TType::STRUCT, count($this->pointBooks));
        {
          foreach ($this->pointBooks as $iter82)
          {
