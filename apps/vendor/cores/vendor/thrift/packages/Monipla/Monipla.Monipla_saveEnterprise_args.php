 ...
 *  @generated
 */
class Monipla_saveEnterprise_args {
  static $_TSPEC;
  ...
  public function getName() {
    return 'Monipla_saveEnterprise_args';
  }
      ...
      switch ($fid)
      {
        case 1:
          if ($ftype == TType::STRUCT) {
            $this->params = new Thrift_Enterprise();
  ...
  public function write($output) {
    $xfer = 0;
    $xfer += $output->writeStructBegin('Monipla_saveEnterprise_args');
    if ($this->params !== null) {
