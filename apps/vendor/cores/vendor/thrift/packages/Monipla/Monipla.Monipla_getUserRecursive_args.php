 ...
 *  @generated
 */
class Monipla_getUserRecursive_args {
  static $_TSPEC;
  ...
  public function getName() {
    return 'Monipla_getUserRecursive_args';
  }
      ...
      switch ($fid)
      {
        case 1:
          if ($ftype == TType::STRUCT) {
            $this->params = new Thrift_UserQuery();
  ...
  public function write($output) {
    $xfer = 0;
    $xfer += $output->writeStructBegin('Monipla_getUserRecursive_args');
    if ($this->params !== null) {
