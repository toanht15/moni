 ...
 *  @generated
 */
class Monipla_getUsingApplications_args {
  static $_TSPEC;
  ...
  public function getName() {
    return 'Monipla_getUsingApplications_args';
  }
      ...
      switch ($fid)
      {
        case 1:
          if ($ftype == TType::STRUCT) {
            $this->parameter = new Thrift_UsingApplicationParameter();
  ...
  public function write($output) {
    $xfer = 0;
    $xfer += $output->writeStructBegin('Monipla_getUsingApplications_args');
