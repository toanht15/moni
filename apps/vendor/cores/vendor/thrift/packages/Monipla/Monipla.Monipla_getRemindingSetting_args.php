 ...
 *  @generated
 */
class Monipla_getRemindingSetting_args {
  static $_TSPEC;
  ...
  public function getName() {
    return 'Monipla_getRemindingSetting_args';
  }
      ...
      switch ($fid)
      {
        case 1:
          if ($ftype == TType::STRUCT) {
            $this->params = new Thrift_SocialAccount();
  ...
  public function write($output) {
    $xfer = 0;
    $xfer += $output->writeStructBegin('Monipla_getRemindingSetting_args');
    if ($this->params !== null) {
