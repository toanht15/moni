 ...
 *  @generated
 */
class Monipla_createRemindQueues_args {
  static $_TSPEC;
  ...
  public function getName() {
    return 'Monipla_createRemindQueues_args';
  }
      ...
      switch ($fid)
      {
        case 1:
          if ($ftype == TType::STRUCT) {
            $this->params = new Thrift_CreateRemindQueuesParameter();
  ...
  public function write($output) {
    $xfer = 0;
    $xfer += $output->writeStructBegin('Monipla_createRemindQueues_args');
    if ($this->params !== null) {
