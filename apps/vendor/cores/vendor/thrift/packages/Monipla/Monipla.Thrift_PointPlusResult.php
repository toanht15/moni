 ...
 *  @generated
 */
class Thrift_PointPlusResult {
  static $_TSPEC;

  public $result = null;
  public $pointPluses = null;
  ...
  public function __construct($vals=null) {
    ...
    if (is_array($vals)) {
      ...
      if (isset($vals['pointPluses'])) {
        $this->pointPluses = $vals['pointPluses'];
      }
      ...
      switch ($fid)
      {
        ...
        case 2:
          if ($ftype == TType::LST) {
            ...
            {
              $elem88 = null;
              $elem88 = new Thrift_PointPlus();
              $xfer += $elem88->read($input);
              $this->pointPluses []= $elem88;
            }
  ...
  public function write($output) {
    $xfer = 0;
    $xfer += $output->writeStructBegin('Thrift_PointPlusResult');
    if ($this->result !== null) {
    ...
    if ($this->pointPluses !== null) {
      if (!is_array($this->pointPluses)) {
        throw new TProtocolException('Bad type in structure.', TProtocolException::INVALID_DATA);
      }
      $xfer += $output->writeFieldBegin('pointPluses', TType::LST, 2);
      {
        $output->writeListBegin(TType::STRUCT, count($this->pointPluses));
        {
          foreach ($this->pointPluses as $iter89)
          {
