 ...
 *  @generated
 */
class Monipla_createAuthorizationCode_args {
  static $_TSPEC;
  ...
  public function getName() {
    return 'Monipla_createAuthorizationCode_args';
  }
      ...
      switch ($fid)
      {
        case 1:
          if ($ftype == TType::STRUCT) {
            $this->parameter = new Thrift_CreateCodeParameter();
  ...
  public function write($output) {
    $xfer = 0;
    $xfer += $output->writeStructBegin('Monipla_createAuthorizationCode_args');
