 ...
 *  @generated
 */
class Monipla_enterpriseBackdoorLogin_args {
  static $_TSPEC;
  ...
  public function getName() {
    return 'Monipla_enterpriseBackdoorLogin_args';
  }
      ...
      switch ($fid)
      {
        case 1:
          if ($ftype == TType::STRUCT) {
            $this->parameter = new Thrift_EnterpriseBackDoorLoginParameter();
  ...
  public function write($output) {
    $xfer = 0;
    $xfer += $output->writeStructBegin('Monipla_enterpriseBackdoorLogin_args');
