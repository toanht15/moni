...
class Thrift_CouponCodeResult {
  ...
  public function getName() {
    return 'Thrift_CouponCodeResult';
  }
      ...
      switch ($fid)
      {
        ...
        case 2:
          if ($ftype == TType::LST) {
            ...
            {
              $elem44 = null;
              $elem44 = new Thrift_CouponCode();
              $xfer += $elem44->read($input);
              $this->couponCodes []= $elem44;
            }
  ...
  public function write($output) {
    $xfer = 0;
    $xfer += $output->writeStructBegin('Thrift_CouponCodeResult');
    if ($this->result !== null) {
    ...
    if ($this->couponCodes !== null) {
      ...
      $xfer += $output->writeFieldBegin('couponCodes', TType::LST, 2);
      {
        $output->writeListBegin(TType::STRUCT, count($this->couponCodes));
        {
          foreach ($this->couponCodes as $iter45)
          {
