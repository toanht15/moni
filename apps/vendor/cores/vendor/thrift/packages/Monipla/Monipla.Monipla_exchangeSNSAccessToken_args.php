 ...
 *  @generated
 */
class Monipla_exchangeSNSAccessToken_args {
  static $_TSPEC;
  ...
  public function getName() {
    return 'Monipla_exchangeSNSAccessToken_args';
  }
      ...
      switch ($fid)
      {
        case 1:
          if ($ftype == TType::STRUCT) {
            $this->parameter = new Thrift_ExchangeAccessTokenParameter();
  ...
  public function write($output) {
    $xfer = 0;
    $xfer += $output->writeStructBegin('Monipla_exchangeSNSAccessToken_args');
