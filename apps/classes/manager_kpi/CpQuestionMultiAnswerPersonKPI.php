...
class CpQuestionMultiAnswerPersonKPI implements IManagerKPI {
    ...
    function doExecute() {
        ...
        $cpQuestionMultiAnswerPerson = $mainte_db->getCountCpQuestionChoiceAnswerPerson($filter);

        return $cpQuestionMultiAnswerPerson[0]['total'];
    }
}