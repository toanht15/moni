...
class ProfileQuestionMultiAnswerKPI implements IManagerKPI {
    ...
    function doExecute() {
        ...
        $profileQuestionMultiAnswer = $mainte_db->getCountProfileQuestionChoiceAnswer($filter);

        return $profileQuestionMultiAnswer[0]['total'];
    }
}