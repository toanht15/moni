...
/**
* Class CpAnnounceDeliveryActionManager
*/
class CpAnnounceDeliveryActionManager extends aafwObject implements CpActionManager {

    use CpActionTrait;

    /** @var CpAnnounceDeliveryActions $cp_concrete_actions */
    ...
    function __construct() {
        ...
        $this->cp_concrete_actions = $this->getModel("CpAnnounceDeliveryActions");
    ...
    public function createConcreteAction(CpAction $cp_action) {
        ...
        $cp_concrete_action->title = "賞品の発送をもって";
