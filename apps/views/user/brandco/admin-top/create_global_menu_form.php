  ...
  <article class="modalInner-large">
    ...
    <section class="modalInner-cont">
      <div class="pageContEdit">
        <form id="frmMenu" name="frmMenu" action="<?php assign(Util::rewriteUrl( 'admin-top', 'create_global_menu' )); ?>" method="POST">
          ...
          <table>
            <tbody>
              ...
              <tr>
	              <th>別ウィンドウで開く</th>
	              <td>
	              	<?php if($data['globalMenu']->is_blank_flg):?>
    ...
    <footer>
      <p class="btnSet"><span class="btn2"><a href="<?php assign(Util::rewriteUrl( 'admin-top', 'global_menus' )); ?>">キャンセル</a></span><span class="btn3"><a href="javascript:void(0)" id="submit" >保存</a></span></p>
    </footer>
  </article>
