...
class save_inquiry_template extends BrandcoPOSTActionBase {
    protected $ContainerName = 'edit_inquiry_template';
    protected $Form = array(
        'package' => 'admin-inquiry',
    ...
    function doAction() {
        ...
        return 'redirect: ' . Util::rewriteUrl(InquiryRoom::getDir(InquiryRoom::TYPE_ADMIN), $this->POST['prev_page']);
    }
}
