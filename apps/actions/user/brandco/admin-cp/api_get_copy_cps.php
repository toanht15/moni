...
class api_get_copy_cps extends BrandcoPOSTActionBase{
    ...
    function doAction()
    {
        ...
        $cp_container = $cp_flow_service->getPublishedCampaign( $this->Data['brand']->id,$this->POST['p'], $this->pageLimit);

        $this->Data['cp_container'] = $cp_container;
        $this->Data['type'] = Cp::SKELETON_COPY;
