...
class edit_youtube_panel_form extends BrandcoGETActionBase {
	...
	public function validate () {
        ...
        $idValidator = new StreamValidator(BrandcoValidatorBase::SERVICE_NAME_YOUTUBE, $brand->id);
	...
	function doAction() {
		...
		return 'user/brandco/admin-top/edit_youtube_panel_form.php';
	}
}