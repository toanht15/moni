...
class edit_facebook_panel_form extends BrandcoGETActionBase {
	...
	public function validate () {
        ...
        $idValidator = new StreamValidator(BrandcoValidatorBase::SERVICE_NAME_FACEBOOK, $brand->id);
	...
	function doAction() {
		...
		return 'user/brandco/admin-top/edit_facebook_panel_form.php';
	}
}