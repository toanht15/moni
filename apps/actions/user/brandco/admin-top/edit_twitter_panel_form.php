...
class edit_twitter_panel_form extends BrandcoGETActionBase {
	...
	public function validate () {
        ...
        $idValidator = new StreamValidator(BrandcoValidatorBase::SERVICE_NAME_TWITTER, $brand->id);
	...
	function doAction() {
		...
		$this->Data['twitterName'] = $brandSocialAccount->name;
		$this->Data['screenName'] = $brandSocialAccount->screen_name;
		$this->Data['picture_url'] = $brandSocialAccount->picture_url;
		...
		return 'user/brandco/admin-top/edit_twitter_panel_form.php';
	}
}