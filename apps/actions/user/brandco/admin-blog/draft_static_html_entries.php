...
class draft_static_html_entries extends BrandcoPOSTActionBase {
    protected $ContainerName = 'draft_static_html_entries';
    ...
    function doAction() {
        ...
        try{
            ...
            $service->draftEntries($this->brand, $this->entries, $this->getBrandsUsersRelation()->user_id);
            ...
            $this->logger->error('draft_static_html_entries action error.' . $e);
            return 'redirect:' . Util::rewriteUrl('admin-blog', 'static_html_entries', array(), array('mid' => 'failed'));
        }

        $this->Data['saved'] = 1;
        return 'redirect:' . Util::rewriteUrl('admin-blog', 'static_html_entries', array(), array('mid' => 'action-draft'));
    }
}
