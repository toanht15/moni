...
class preview_update_brand_notification extends BrandcoManagerGETActionBase {
    ...
    function doAction() {
        try {
            ...
            $this->Data['update_brand_information']['contents'] = $content['contents'];
        } catch (Exception $e) {
            $logger = aafwLog4phpLogger::getDefaultLogger();
            $logger->error($e);
        }

        return 'manager/dashboard/preview_update_brand_notification.php';
    }
}