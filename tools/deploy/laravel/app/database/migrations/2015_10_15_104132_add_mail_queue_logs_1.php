...
class AddMailQueueLogs1 extends Migration {
	...
	public function up()
	{
		Schema::create('mail_queue_logs_1', function(Blueprint $table)
		{
			$table->increments('id');
			...
			$table->timestamps();
			$table->unique(array('user_id', 'cp_message_delivery_reservation_id'), 'mql1_ui1');
		});
	}
	...
	{
		Schema::table('mail_queue_logs_1', function(Blueprint $table)
		{
			$table->drop();
		});
	}
